...
srun python deeplearning/ml4pl/models/ggnn/run_ggnn_poj104.py --log_dir=deeplearning/ml4pl/poj104/classifyapp_logs/subset_degradation_baselines/ --config_json="{'layer_timesteps': [2, 2, 2], 'lr': 0.0005, 'batch_size': 64, 'output_dropout': 0.0, 'edge_weight_dropout': 0.0, 'graph_state_dropout': 0.1, 'train_subset': [0, 100]}"
