...
subfolder = 'threadcoarsening_logs/transformer_transfer_Cypress_2'
...
dataset = 'threadcoarsening_Cypress' # poj104, ncc, devmap_amd, _nvidia, threadcoarsening_Cypress, _Tahiti, _Fermi, _Kepler
