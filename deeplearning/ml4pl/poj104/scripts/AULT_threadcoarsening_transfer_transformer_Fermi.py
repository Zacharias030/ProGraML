...
subfolder = 'threadcoarsening_logs/transformer_transfer_Fermi_2'
...
dataset = 'threadcoarsening_Fermi' # poj104, ncc, devmap_amd, _nvidia, threadcoarsening_Cypress, _Tahiti, _Fermi, _Kepler
