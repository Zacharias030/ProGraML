"""transformer branch prediction"""

########### Make your changes below the line ######################

# subfolder under classifyapp_logs/
subfolder = 'branch_prediction_logs/transformer_supervised_random'
# choose 3 letters to identify your experiment
jobname = 'brs'

model = 'transformer_branch_prediction'  # 'ggnn_SET' or 'transformer_SET' or 'x_pretraining' (dataset without split!)
