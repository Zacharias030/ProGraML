...
ProgramGraphFeatures = _reflection.GeneratedProtocolMessageType('ProgramGraphFeatures', (_message.Message,), dict(
...
ProgramGraphFeaturesList = _reflection.GeneratedProtocolMessageType('ProgramGraphFeaturesList', (_message.Message,), dict(
